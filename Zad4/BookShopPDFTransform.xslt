      ...
      <fo:root>
         ...
         <fo:page-sequence master-reference="A4">
            <fo:flow flow-name="xsl-region-body">
               ...
               <fo:block linefeed-treatment="preserve">Authors details</fo:block>
               <fo:table>
                  ...
                  <fo:table-header>
                     <fo:table-row>
                        ...
                        <fo:table-cell border="1px solid black">
                           <fo:block font-weight="bold" width="30mm" font-size="14px">Number of Books</fo:block>
                        </fo:table-cell>
                        <fo:table-cell border="1px solid black">
                           <fo:block font-weight="bold" font-size="14px">Value of Books</fo:block>
                        </fo:table-cell>
                     </fo:table-row>
                  </fo:table-header>
                  <fo:table-body>
